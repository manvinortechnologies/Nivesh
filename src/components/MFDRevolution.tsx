                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative grid grid-cols-2 gap-4">
                            {/* Old Way Card */}
                            <div className="bg-neutral-100 rounded-2xl p-6 transform rotate-[-2deg] translate-y-4 opacity-80 scale-95 hover:opacity-100 hover:scale-100 hover:rotate-0 transition-all duration-500 shadow-lg border border-neutral-200">
                            ...
                            {/* New Way Card */}
                            <div className="bg-white rounded-2xl p-6 transform rotate-[2deg] -translate-y-4 shadow-2xl border border-primary/10 z-10 hover:rotate-0 transition-all duration-500">
                                ...
                                <div className="space-y-4">
                                    {/* Chart Placeholder */}
                                    <div className="h-24 bg-gradient-to-br from-primary/5 to-primary/10 rounded-lg flex items-end justify-between p-2 gap-1">
                                        <div className="w-full bg-primary/20 rounded-t h-1/3"></div>
                                        <div className="w-full bg-primary/40 rounded-t h-2/3"></div>
                                        <div className="w-full bg-primary/60 rounded-t h-1/2"></div>
